...
def reimplemented_validate_res_labels(eval_labels, y_pred):  # TODO
...
def reimplemented_evaluate(y_gold, y_pred, eval_labels):  # TODO
    """Get the scores
    Inputs:
        y_gold: list of labels (strings)
        y_pred: list of labels (strings)
    ...
    Returns:
        sklearn classification report (string)
    """
    y_gold = validate_ref_labels(eval_labels, y_gold)
    y_pred = reimplemented_validate_res_labels(eval_labels, y_pred)
    return classification_report(y_gold, y_pred, labels=eval_labels, output_dict=True)

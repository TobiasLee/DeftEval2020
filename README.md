...
[DeftEval 2020 Definition Extraction, SemEval2020 Task 6](https://competitions.codalab.org/competitions/22759). 
...
### Running scripts
#### Train the RoBERTa-large model
```bash
bash scripts/run_task1.sh
```
#### Train the qa-suffix-RoBERTa-large model
```bash
bash scripts/run_task1_qa.sh
```
#### Evaluate the [pre-trained qa-suffix-RoBERTa-large from Hugging Face](https://huggingface.co/tobiaslee/roberta-large-qa-suffix-defteval-t6-st1/tree/main)
```bash
bash scripts/evaluation/test_task1.sh
```
...
| --------------------- | ---- | ---- | ---- | ---- | ---- |
| RoBERTa-base | 0.8876 | 0.8262 | 0.2906 | 0.8321 | 0.8204 |
...
| RoBERTa-large | 0.8888 | 0.8342 | 0.3001 | 0.8106 | 0.8592 |
...
|                       | eval_accuracy | eval_f1 | eval_loss | eval_precision | eval_recall |
| --------------------- | ---- | ---- | ---- | ---- | ---- |
| RoBERTa-base | 0.8545 | 0.7748 | 0.3556 | 0.779 | 0.7706 |
...
| RoBERTa-large | 0.8661 | 0.8007 | 0.3613 | 0.7752 | 0.828 |
...
```
#### Train the RoBERTa-large model with focal loss
```bash
bash scripts/run_task2_focalloss.sh
```
#### Evaluate the [pre-trained RoBERTa-large from Hugging Face](https://huggingface.co/tobiaslee/roberta-large-defteval-t6-st2/tree/main)
```bash
bash scripts/evaluation/test_task2.sh
```
...
### Running scripts
#### Train the RoBERTa-base model
```bash
bash scripts/run_task3.sh
```
#### Evaluate the [pre-trained RoBERTa-base from Hugging Face](https://huggingface.co/tobiaslee/roberta-base-defteval-t6-st3/tree/main)
```bash
bash scripts/evaluation/test_task3_base.sh
```
#### Evaluate the [pre-trained RoBERTa-large from Hugging Face](https://huggingface.co/tobiaslee/roberta-large-defteval-t6-st3/tree/main)
```bash
bash scripts/evaluation/test_task3_base.sh
```
